<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormularioEmpresas.aspx.cs" Inherits="WebAppEmpleos.FormularioEmpresas" %>
                ...
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="industria" class="col-md-4 col-form-label text-md-right">Industria</label>

                                    <div class="col-md-6">
                                        <asp:TextBox ID="txtIndustria" runat="server" CssClass="form-control"></asp:TextBox>                                
                                    </div>
                                </div>
